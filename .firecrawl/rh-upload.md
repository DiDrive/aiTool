...
paths:
 ...
 ![image-20250904172450259](https://api.apifox.com/api/v1/projects/6103976/resources/570186/image-preview)

 ### 2.在对应位置填入响应信息

 找到指定位置

 ![image-20250904172450259](https://api.apifox.com/api/v1/projects/6103976/resources/570187/image-preview)

 填写信息

 ![image-20250904172450259](https://api.apifox.com/api/v1/projects/6103976/resources/570188/image-preview)
 ...
 format: binary
 type: string
 example: file://D:\\temp\\ComfyUI\_00743\_uiqpt\_1742470204.png
 fileType:
 type: string
 example: input
 required:
 ...
 value:
 code: 809
 msg: APIKEY\_FILE\_SIZE\_EXCEEDED
 data: null
 headers: {}
 x-apifox-name: 成功
 security: \[\]
 ...
 x-run-in-apifox: https://app.apifox.com/web/project/7913447/apis/api-425749008-run
components:
 schemas:
 RTaskUploadResponse:
 type: object
