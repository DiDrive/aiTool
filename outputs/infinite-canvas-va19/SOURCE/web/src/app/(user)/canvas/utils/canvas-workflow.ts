...
export const CANVAS_WORKFLOW_NODE_PRESETS: Record<CanvasWorkflowNodeKind, CanvasWorkflowNodePreset> = {
    ...
    storyboard_script: {
        ...
        metadata: { workflowKind: "storyboard_script", generationMode: "text", prompt: "把上游结构化剧本拆成可制作的分镜脚本。所有字段内容必须使用简体中文，除必要的专有名词外禁止使用英文。镜头总时长必须等于剧本总时长；保持原始 startMs/endMs、剧情顺序、人物、场景、道具和原始台词，每个字段必须与该镜头内容对应，禁止输出教程或创作建议。只输出 JSON，不要 Markdown。格式：{\"shots\":[{\"shotNumber\":\"1\",\"startMs\":0,\"endMs\":4000,\"durationSeconds\":4,\"shotSize\":\"中景\",\"scene\":\"场景\",\"sceneId\":\"scene_1\",\"characters\":[\"人物\"],\"characterIds\":[\"character_1\"],\"props\":[\"道具\"],\"visual\":\"画面描述\",\"action\":\"按时间顺序描述动作\",\"camera\":\"运镜\",\"lighting\":\"光线\",\"dialogue\":\"对白/旁白\",\"sound\":\"声音\",\"continuity\":\"连续性要求\",\"evidenceTimestampsMs\":[0,2000,3999],\"confidence\":0.9}]}。", status: "idle" },
    },
    character: {
        kind: "character",
