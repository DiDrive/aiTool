...
const buildSeedanceVideoTaskRecord = (
    ...
    return {
        ...
        modelConfig: {
            ...
            submitPath: isKwjm ? "/v3/contents/generations/tasks" : "/api/v3/contents/generations/tasks",
            queryPath: isKwjm ? "/v3/contents/generations/tasks/{id}" : "/api/v3/contents/generations/tasks/{id}",
